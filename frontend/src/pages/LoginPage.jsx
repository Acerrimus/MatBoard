...
export default function LoginPage() {
  ...
  const handleEmailAuth = async (e) => {
    ...
    setSubmitting(true)
    try {
      const fn = mode === 'login' ? signInWithEmail : signUp
        ...
        <div style={{
          ...
          <form onSubmit={handleEmailAuth}>
            <div style={{ marginBottom: 12 }}>
              <label style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: 6 }}>
                Email
              </label>
              <input
                type="email"
